...
// Pulls `?plant=` off the URL and sanitizes it: lowercase, only
// letters/numbers/underscore/hyphen, capped length. Anything else
// (empty, missing, malformed) falls back to plant_01. This keeps
// stray characters out of the database and out of innerHTML.
